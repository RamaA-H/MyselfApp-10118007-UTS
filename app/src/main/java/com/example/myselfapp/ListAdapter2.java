...
public class ListAdapter2 extends RecyclerView.Adapter {
    ...
    public int getItemCount() {
        return com.example.myselfapp.Data.friendlist_daily.length;
    }
    ...
    public class ListViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void bindView(int position){
            mItemText.setText(com.example.myselfapp.Data.friendlist_daily[position]);
            mItemImage.setImageResource(com.example.myselfapp.Data.firendlistDailyPicturePath[position]);
